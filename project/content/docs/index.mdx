---
title: Installation
description: Getting started with Forked UI
icon: ListStart
---
...
> **Important:** Replace `https://your-domain.com` with the actual URL where you deploy this project.

<Tabs items={["bun", "npx", "pnpm"]}>
 
```bash tab="bun"
bunx shadcn@latest add https://your-domain.com/r/utils.json 
```
 
```bash tab="npx"
npx shadcn@latest add https://your-domain.com/r/utils.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://your-domain.com/r/utils.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://your-domain.com/r/card-05.json
```
 
```bash tab="npx"
npx shadcn@latest add https://your-domain.com/r/card-05.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://your-domain.com/r/card-05.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://your-domain.com/r/ai-card-generation.json
```
 
```bash tab="npx"
npx shadcn@latest add https://your-domain.com/r/ai-card-generation.json
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://your-domain.com/r/ai-card-generation.json
```
...
```bash tab="bun"
bunx shadcn@latest add https://your-domain.com/r/card-05.json -c ./apps/www
```
 
```bash tab="npx"
npx shadcn@latest add https://your-domain.com/r/card-05.json -c ./apps/www
```

```bash tab="pnpm"
pnpm dlx shadcn@latest add https://your-domain.com/r/card-05.json -c ./apps/www
```
