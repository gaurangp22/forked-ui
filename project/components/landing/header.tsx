        ...
        >
          <span className="flex items-center gap-2">
            <PartyPopper className="w-3.5 h-3.5" />
              <span className="text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-blue-600 bg-clip-text font-semibold">
          ...
          <div className="group relative inline-flex items-center gap-2 px-3 py-1 text-sm rounded-lg bg-zinc-900 dark:bg-zinc-100 transition-colors">
            <div className="absolute inset-0 rounded-lg bg-gradient-to-r from-blue-500 via-purple-500 to-blue-600 opacity-40 group-hover:opacity-80 blur-sm transition-opacity duration-500" />
