...
const defaultProps: Card01Props = {
    ...
    content: {
        text: "Just launched Forked UI! Check out the documentation and let me know what you think 🎨",
        link: {
            title: "Forked UI Documentation",
            description: "A comprehensive guide to Forked UI",
